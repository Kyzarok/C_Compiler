...
%type <Node> PROGRAM FNC_DEC T_INT T_IDENTIFIER K_INT K_RETURN O_PLUS O_EQUALS O_MINUS O_ASTR O_DIV L_IS_EQUAL L_IS_NOT_EQUAL L_AND L_OR L_NOT B_AND B_OR B_NOT B_XOR B_LSHIFT B_RSHIFT TYPE_SPEC FNC_ID COMPOUND_STATEMENT STATEMENT_LIST STATEMENT RETURN_STATEMENT EXPRESSION CONSTANT OPERATOR
...
EXPRESSION : CONSTANT
	|	OPERATOR	//I know this isn't quite right, but I needed a place to declare Operators
					// Don't know what the solution is, but briefly aded OPERATOR as a type node to "compiles" again
